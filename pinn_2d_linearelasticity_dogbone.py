...
bcs_overlap_angle_distance = 20.0
# Validation
...
output_subdirectory = f"{output_date}_pinn_linearelasticity_dogbone_E_210k_nu_03_col_8192_bc_128_PDE_dirichlet_free_overlap_dist_20"
