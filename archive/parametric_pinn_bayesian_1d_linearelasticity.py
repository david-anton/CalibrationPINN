...
from calibrationpinn.bayesian.prior import create_univariate_normal_distributed_prior
...
from calibrationpinn.training.training_bayesian_linearelasticity_stretchedrod import (
