...
from parametricpinn.training.training_standard_neohooke_platewithhole import (
...
number_training_epochs = 60000  # 20000
weight_pde_loss = 1.0
weight_traction_bc_loss = 1.0
weight_symmetry_bc_loss = 1e4
# Validation
regenerate_valid_data = True
input_subdir_valid = "20240202_validation_data_neohooke_platewithhole_K_1k_G_400_length_200_height_100_radius_10_traction_50_elementsize_02"
...
output_subdirectory = f"{output_date}_forward_pinn_neohooke_platewithhole_K_1k_G_400_col_8192_bc_256_neurons_6_128_traction_50"
...
def create_datasets() -> tuple[PlateWithHoleTrainingDataset2D, ValidationDataset2D]:
    def _create_training_dataset() -> PlateWithHoleTrainingDataset2D:
        ...
        config_training_data = PlateWithHoleTrainingDataset2DConfig(
...
def create_ansatz() -> StandardAnsatz:
    ...
    def _determine_normalization_values() -> dict[str, Tensor]:
        if retrain_parametric_pinn:
            half_length = plate_length / 2
            half_height = plate_height / 2
            min_coordinate_x = -half_length
            max_coordinate_x = half_length
            min_coordinate_y = -half_height
            max_coordinate_y = half_height
    ...
    return create_standard_normalized_hbc_ansatz_clamped_left(
        coordinate_x_left=torch.tensor([-plate_length / 2]),
