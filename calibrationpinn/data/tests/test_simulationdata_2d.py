...
from calibrationpinn.data.dataset import SimulationData, SimulationDataList
...
from calibrationpinn.settings import Settings, set_seed
from calibrationpinn.types import Tensor


class FakeSetting(Settings):
    def __init__(self) -> None:
        self.PROJECT_DIR = Path() / "calibrationpinn" / "data" / "tests"
