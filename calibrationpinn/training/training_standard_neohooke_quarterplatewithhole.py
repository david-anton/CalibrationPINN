...
from calibrationpinn.data.trainingdata_2d import QuarterPlateWithHoleTrainingDataset2D
...
from calibrationpinn.training.loss_2d.momentum_neohooke import (
...
def train_parametric_pinn(train_config: TrainingConfiguration) -> None:
    ...
    first_piola_kirchhoff_stress_func = first_piola_kirchhoff_stress_func_factory()
    ...
    def loss_func_closure() -> float:
        ...
        loss_collocation, loss_stress_bc, loss_traction_bc, loss_data = loss_func(
            ansatz, batch_collocation, batch_stress_bc, batch_traction_bc, batch_data
        )
