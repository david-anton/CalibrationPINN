...
from calibrationpinn.errors import FEMDomainConfigError, PlottingConfigError
...
from calibrationpinn.fem import SimulationConfig as FEMSimulationConfig
...
def _plot_results(
    ...
    _plot_errors(
        ...
        coordinates_x=simulation_results.coordinates_x,
        coordinates_y=simulation_results.coordinates_y,
        title=r"Absolute error $u_{x}$ [mm]",
    ...
    _plot_errors(
        ...
        coordinates_x=simulation_results.coordinates_x,
        coordinates_y=simulation_results.coordinates_y,
        title=r"Absolute error $u_{y}$ [mm]",
