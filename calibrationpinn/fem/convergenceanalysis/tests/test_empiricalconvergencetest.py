...
from calibrationpinn.fem.convergenceanalysis.empiricalconvergencetest import (
...
def test_calculate_empirical_convergence_order(
    results: list[float], reduction_factor: float, expected: float
) -> None:
