...
from calibrationpinn.data.geometry.dogbone_2d import DogBoneGeometryConfig
...
from calibrationpinn.fem.boundaryconditions import (
    BoundaryConditions,
    DirichletBC,
    NeumannBC,
)
from calibrationpinn.fem.domains.base import (
