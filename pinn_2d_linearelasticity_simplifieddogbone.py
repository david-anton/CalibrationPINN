...
# Network
layer_sizes = [4, 256, 256, 256, 256, 256, 256, 2] #[4, 128, 128, 128, 128, 128, 128, 2]
# Ansatz
...
output_subdirectory = f"{output_date}_pinn_linearelasticity_simplifieddogbone_E_210k_nu_03_col_16384_bc_512_neurons_6_256_symmetry_1e5"
