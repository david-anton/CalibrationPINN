...
# Network
layer_sizes = [4, 16, 16, 2] #[4, 32, 32, 32, 32, 2]
# Ansatz
...
output_subdirectory = f"{output_date}_pinn_linearelasticity_simplifieddogbone_E_210k_nu_03_col_4096_bc_128_neurons_4_32_tapered_energy_sobol_neurons_2_16"
