...
from parametricpinn.training.pinn_training_standard_linearelasticity_simplifieddogbone import (
...
# Network
layer_sizes = [4, 64, 64, 64, 64, 64, 64, 2] #[4, 64, 64, 64, 64, 2]
# Ansatz
...
bcs_overlap_distance_left = 1e-2
...
input_subdir_valid = "20231219_validation_data_linearelasticity_simplifieddogbone_E_210k_nu_03_elementsize_01_rectangle_tapered"
num_samples_valid = 1
...
output_subdirectory = f"{output_date}_pinn_linearelasticity_simplifieddogbone_E_210k_nu_03_col_4096_bc_128_neurons_6_64_rectangle_tapered"
